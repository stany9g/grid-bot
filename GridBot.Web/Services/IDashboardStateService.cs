...
public interface IDashboardStateService : IAsyncDisposable
{
    ...
    /// <summary>
    /// Adds an alert to the dashboard and optionally sends it via webhook.
    /// </summary>
    Task AddAlertAsync(AlertItem alert, bool sendWebhook = true, CancellationToken ct = default);
